 ...
 *
 * Private pages call `requireEditor()` / `requireAdmin()` / `requireUser()` themselves. Putting the
 * guard here instead would be one line shorter and would lock the whole
 * songbook behind a login.
 *
 * `getSessionProfile` is React-cached, so a child page calling `requireEditor()`
