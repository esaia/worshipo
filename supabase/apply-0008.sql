-- Worshipo — migration 0008. RUN THIS ONLY AFTER apply-0007.sql HAS SUCCEEDED.
--
-- It reads `role in ('admin', 'co_admin')`, which is a syntax error against a
-- database where 0007 has not committed yet.
